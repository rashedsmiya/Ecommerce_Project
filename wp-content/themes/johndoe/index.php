...
<head>
    ...
    <!-- font icons --> 
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/vendors/themify-icons/css/themify-icons.css"> 
    <!-- Bootstrap + JohnDoe main styles -->
	<link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/css/johndoe.css">
    <?php wp_head();?> 
</head> 
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-content"> 
                ...
                <a href="<?php echo get_theme_mod('theme_setting_cv');?>" class="btn btn-primary btn-rounded"> <i class="ti-printer pr-2"></i>Print Resume</a>
            </div>
        </div> 
    </header>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    <img src="<?php echo get_template_directory_uri();?>/imgs/avatar.jpg" alt="" class="brand-img">
                    <li class="brand-txt">
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-4 about-card">
                <h3 class="font-weight-light"><?php echo get_theme_mod('theme_setting_ide');?></h3>
                <span class="line mb-5"></span>
                <h5 class="mb-3"><?php echo get_theme_mod('theme_setting_id12');?></h5>
                <p class="mt-20"><?php echo get_theme_mod('theme_setting_id13');?></p>
                <a href="<?php echo get_theme_mod('theme_setting_cv1');?>" class="btn btn-outline-danger"><i class="icon-down-circled2"></i>Download My CV</a>            
            </div>
            <div class="col-lg-4 about-card">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                       <div class="card-header">
                            <div class="mt-2">
                                <h4><?php echo get_theme_mod('theme_setting_id2');?></h4>
                                <span class="line"></span>    
                            </div>
                        </div> 
                        <div class="card-body">
                            <h6 class="title text-danger"><?php echo get_theme_mod('theme_setting_designation2');?></h6>
                            <P><?php echo get_theme_mod('theme_setting_cv2');?></P>
                            <P class="subtitle"><?php echo get_theme_mod('theme_setting_cv22');?></P>
                            <hr>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="row ">
                        ...
                        <div class="col-7 text-left py-3">
                            <h1 class="text-danger font-weight-bold font40"><?php echo get_theme_mod('theme_setting_id4');?></h1>
                            <p class="text-light mb-1"><?php echo get_theme_mod('theme_setting_designation4');?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="row">
                        ...
                        <div class="col-7 text-left py-3">
                            <h1 class="text-danger font-weight-bold font40"><?php echo get_theme_mod('theme_setting_cv4');?></h1>
                            <p class="text-light mb-1"><?php echo get_theme_mod('theme_setting_cv24');?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            <h5 class="mb-3 card-title text-dark"><?php echo get_theme_mod('theme_setting_id3');?></h5>
                            <P class="subtitle"><?php echo get_theme_mod('theme_setting_designation3');?></P>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            <h5 class="mb-3 card-title text-dark"><?php echo get_theme_mod('theme_setting_cv3');?></h5>
                            <P class="subtitle"><?php echo get_theme_mod('theme_setting_cv23');?></P>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                ...
                <div class="portfolio-container"> 
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/web-1.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/web-1.jpg"></a>
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/web-2.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/web-2.jpg"></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/advertising-2.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                         
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/advertising-2.jpg"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/web-4.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/web-4.jpg"></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising"> 
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/advertising-1.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                               
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/advertising-1.jpg"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/web-3.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">  
                           <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/web-3.jpg"></a>
                                <div class="text-holder">
                                    <h6 class="title">WEB</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/advertising-3.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">       
                           <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/advertising-3.jpg"></a>
                                <div class="text-holder">
                                    <h6 class="title">ADVERSITING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 advertising new"> 
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/advertising-4.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">            
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/advertising-4.jpg"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/branding-1.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                        
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/branding-1.jpg"></a>
                                <div class="text-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/branding-2.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">  
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/branding-2.jpg"></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/branding-3.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">   
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/branding-3.jpg"></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/branding-4.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">                      
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/branding-4.jpg"></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="<?php echo get_template_directory_uri();?>/imgs/branding-5.jpg" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">          
                            <div class="content-holder">
                                <a class="img-popup" href="<?php echo get_template_directory_uri();?>/imgs/branding-5.jpg"></a>
                                <div class="text-holder">
                                    <h6 class="title">BRANDING</h6>
                                    <p class="subtitle">Expedita corporis doloremque velit in totam!</p>
                                </div>
            ...
            <div class="row">
                <div class="blog-card">
                    <div class="img-holder">
                        <img src="<?php echo get_theme_mod('theme_setting_hero_banner');?>" alt="Download free bootstrap 4 landing page, free boootstrap 4 templates, Download free bootstrap 4.1 landing page, free boootstrap 4.1.1 templates, meyawo Landing page">
                    </div>
                    <div class="content-holder">
                        <h6 class="title"><?php echo get_theme_mod('theme_setting_designation5');?></h6>
                        <p class="post-details">
                            <a href="#">By: Admin</a>
                            <a href="#"><i class="ti-heart text-danger"></i> 234</a>
                            <a href="#"><i class="ti-comment"></i> 123</a>
                        </p>
                        <p><?php echo get_theme_mod('theme_setting_cv5');?></p>

                        <p><b>Necessitatibus nihil impedit! Ex nisi eveniet, dolor aliquid consequuntur repudiandae.</b></p>
                        <p><?php echo get_theme_mod('theme_setting_cv25');?></p>
	...
	<!-- core  -->
    <script src="<?php echo get_template_directory_uri();?>/vendors/jquery/jquery-3.4.1.js"></script>
    <script src="<?php echo get_template_directory_uri();?>/vendors/bootstrap/bootstrap.bundle.js"></script>

    <!-- bootstrap 3 affix -->
    <script src="<?php echo get_template_directory_uri();?>/vendors/bootstrap/bootstrap.affix.js"></script>

    <!-- Isotope  -->
    <script src="<?php echo get_template_directory_uri();?>/vendors/isotope/isotope.pkgd.js"></script>
    
    <!-- Google mpas -->
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCtme10pzgKSPeJVJrG1O3tjR6lk98o4w8&callback=initMap"></script>

    <!-- JohnDoe js -->
    <script src="<?php echo get_template_directory_uri();?>/js/johndoe.js"></script>
<?php wp_footer();?>
</body>
</html>
